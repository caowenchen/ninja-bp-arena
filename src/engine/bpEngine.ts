import type { BPActionType, BattleRule, Side } from '@/types/bp'
import type { EngineResult, GameState, MatchState } from '@/types/match'
 ...
 *   为未来远程双人 BP（服务端 authoritative state）留出空间。
